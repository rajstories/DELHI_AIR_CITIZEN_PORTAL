...
export const WhatsAppChannelCard: React.FC = () => {
  const handleJoin = () => {
  ...
  return (
    ...
    >
      ...
      {/* WhatsApp Icon */}
      <div className="bg-[#25D366] p-2.5 rounded-full shrink-0 flex items-center justify-center text-white shadow-sm z-10">
      ...
      <div className="flex-1 z-10">
        <h3 className="font-bold text-green-900 text-sm leading-tight mb-1">Get Alerts on WhatsApp</h3>
        <p className="text-[10px] text-green-700 font-medium leading-snug">
          Join our official channel. Privacy protected - No one can see your number.
        </p>
      </div>
